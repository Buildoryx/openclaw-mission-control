    ...
    >
      <div className="space-y-2">
        <label className="text-sm font-medium text-[var(--text)]">
          Gateway name <span className="text-[var(--danger)]">*</span>
        </label>
        <Input
          value={name}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          <label className="text-sm font-medium text-[var(--text)]">
            Gateway URL <span className="text-[var(--danger)]">*</span>
          </label>
          ...
          {gatewayUrlError ? (
            <p className="text-xs text-[var(--danger)]">{gatewayUrlError}</p>
          ) : gatewayCheckStatus === "error" && gatewayCheckMessage ? (
            <p className="text-xs text-[var(--danger)]">{gatewayCheckMessage}</p>
          ) : null}
        </div>
        <div className="space-y-2">
          <label className="text-sm font-medium text-[var(--text)]">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          <label className="text-sm font-medium text-[var(--text)]">
            Workspace root <span className="text-[var(--danger)]">*</span>
          </label>
          <Input
            value={workspaceRoot}
