...
function riskPillClassName(risk: string | null | undefined) {
  ...
  switch (normalizedRisk) {
    case "safe":
    case "low":
      return "bg-[color:rgba(16,185,129,0.16)] text-[var(--success)] border border-emerald-200/70";
    case "medium":
    case "moderate":
      return "bg-[color:rgba(245,158,11,0.16)] text-[var(--alert-warning-text)] border border-amber-200/70";
    case "elevated":
      return "bg-[color:rgba(245,158,11,0.16)] text-[var(--alert-warning-text)] border border-amber-200/70";
    case "high":
    case "critical":
    ...
    case "unknown":
      return "bg-[color:rgba(148,163,184,0.16)] text-[var(--text-muted)] border border-[var(--border)]/80";
    default:
...
export function MarketplaceSkillsTable({
          ...
          <div>
            {onSkillClick ? (
              <button
                ...
                className="text-sm font-medium text-blue-700 hover:text-[var(--accent)] hover:underline"
              >
                {row.original.name}
              </button>
            ) : (
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className="text-blue-700 hover:text-[var(--accent)] hover:underline"
                    >
                      {gateway.name}
                    </Link>
                    {!isLast ? "," : ""}
  ...
  return (
    <DataTable
      ...
      rowClassName="transition hover:page-bg"
