  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <div className="mt-3 inline-flex rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] p-1">
          <button
            type="button"
            className={cn(
      ...
      {scope === "all" ? (
        <div className="flex flex-wrap items-center gap-6 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-sm">
        ...
        <DialogContent>
          ...
          {memberDetailsQuery.isLoading ? (
            ...
            <div className="space-y-6">
              ...
              {accessError ? (
                <p className="text-sm text-[var(--danger)]">{accessError}</p>
              ) : null}
            </div>
          ) : (
            <div className="rounded-xl border border-[var(--border)] page-bg px-4 py-3 text-sm text-[var(--text-muted)]">
          ...
          <DialogFooter className="pt-2">
            {activeMemberCanBeRemoved ? (
              <Button
                type="button"
                variant="outline"
                className="mr-auto border-rose-200 text-[var(--danger)] hover:border-rose-300 hover:text-[var(--danger)]"
                onClick={() => {
