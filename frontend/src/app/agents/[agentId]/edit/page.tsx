    ...
    >
      ...
      >
        <div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm font-medium text-[var(--text)]">
                  Agent name <span className="text-[var(--danger)]">*</span>
                </label>
                <Input
                  value={resolvedName}
          ...
          <div className="mt-6 rounded-xl border border-[var(--border)] page-bg p-4">
            <label className="flex items-start gap-3 text-sm text-[var(--text-muted)]">
              <input
                type="checkbox"
                className="mt-1 h-4 w-4 rounded border-[var(--border-strong)] text-[var(--accent)] focus:ring-[var(--accent-soft)]"
