...
const statusTone = (value?: string | null) => {
  switch (value) {
    ...
    case "done":
      return "page-bg text-[var(--text-muted)] border-[var(--border)]";
    default:
        ...
        <main className="flex-1 overflow-y-auto page-bg">
            ...
            <div className="px-8 py-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  {group?.description ? (
                    ...
                    <p className="mt-2 text-sm text-[var(--text-quiet)]">
                      No description
                    </p>
                  )}
                </div>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center gap-2 text-sm text-[var(--text-muted)]">
                  <span className="text-[var(--text-muted)]">Top tasks per board</span>
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm text-[var(--text-muted)]">
                  <span className="text-[var(--text-muted)]">Agent pace</span>
                  <div className="flex flex-wrap items-center gap-1 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-1">
                  ...
                  <input
                    ...
                    className={cn(
                      "h-8 w-20 rounded-md border bg-[var(--surface)] px-2 text-xs text-[var(--text)] shadow-sm",
                      heartbeatEvery
                        ? "border-[var(--border)]"
                  ...
                  <select
                    ...
                    className={cn(
                      "h-8 rounded-md border border-[var(--border)] bg-[var(--surface)] px-2 text-xs text-[var(--text)] shadow-sm",
                      !canManageHeartbeat && "opacity-60 cursor-not-allowed",
                    )}
                    disabled={!canManageHeartbeat}
                  >
          ...
          <div className="p-8">
            <div className="space-y-6">
              {heartbeatApplyError ? (
                <div className="rounded-xl border border alert-danger p-4 text-sm text-[var(--danger)] shadow-sm">
                  {heartbeatApplyError}
                </div>
              ) : null}
              ...
              {snapshotQuery.isLoading ? (
                <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6 text-sm text-[var(--text-muted)] shadow-sm">
                  Loading group snapshot…
                </div>
              ) : snapshotQuery.error ? (
                <div className="rounded-xl border border alert-danger p-6 text-sm text-[var(--danger)] shadow-sm">
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="min-w-0">
                            ...
                            >
                              ...
                              <ArrowUpRight className="h-4 w-4 text-[var(--text-quiet)] group-hover:text-[var(--accent)]" />
                            </Link>
                          ...
                          <div className="flex flex-wrap items-center justify-end gap-2 text-xs">
                            <span className="rounded-full border border-[var(--border)] page-bg px-2 py-0.5 text-[var(--text-muted)]">
                              Inbox {safeCount(item, "inbox")}
                            </span>
                            <span className="rounded-full border border alert-success px-2 py-0.5 text-[var(--success)]">
                            ...
                            {item.tasks.map((task) => (
                              <li key={task.id}>
                                <Link
                                  ...
                                  className="block rounded-lg border border-[var(--border)] bg-[var(--surface-muted)]/40 p-3 transition hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2"
                                ...
                                >
                                  ...
                                  <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-xs text-[var(--text-muted)]">
                                    ...
                                    <p className="font-mono text-[11px] text-[var(--text-quiet)]">
                                      {task.id}
                                    </p>
                                  </div>
                                </Link>
