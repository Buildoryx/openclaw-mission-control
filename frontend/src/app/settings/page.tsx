    ...
    <>
      ...
      >
        <div className="space-y-6">
            ...
            <form onSubmit={handleSave} className="mt-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  readOnly
                  disabled
                  className="border-[var(--border)] page-bg text-[var(--text-muted)]"
                />
              </div>
              ...
              {saveSuccess ? (
                <div className="rounded-lg border border alert-success p-3 text-sm text-[var(--success)]">
                  {saveSuccess}
                </div>
              ) : null}
          ...
          <section className="rounded-xl border border alert-danger/70 p-6 shadow-sm">
