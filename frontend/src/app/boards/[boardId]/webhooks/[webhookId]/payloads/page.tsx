  ...
  return (
    ...
    >
      <div className="space-y-4 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-[var(--border)] px-3 py-2">
          <p className="text-sm text-[var(--text-muted)]">
        ...
        {isLoading ? (
          <p className="text-sm text-[var(--text-muted)]">Loading payloads...</p>
        ) : null}
